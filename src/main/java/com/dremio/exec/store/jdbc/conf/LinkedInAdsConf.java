...
@SourceType(value = "LinkedInAdsARP", label = "LinkedInAds",uiConfig = "linkedinads-layout.json")
public class LinkedInAdsConf extends AbstractArpConf<LinkedInAdsConf> {
  private static final String ARP_FILENAME = "arp/implementation/linkedinads-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.linkedinads.LinkedInAdsDriver";
